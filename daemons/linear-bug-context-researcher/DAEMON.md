...
Before commenting, inspect existing Charlie comments on the issue. If an equivalent `Bug triage context` comment already covers the same issue content and search results, no-op.

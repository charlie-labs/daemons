...
- Source paths: `src/**`, `scripts/**`, `daemons/**`, `skills/**`, `.github/**`, `package.json`, `bun.lock`, `tsconfig.json`, `AGENTS.md`, `README.md`, `RELEASING.md`, and `docs/**`
- Documentation paths: `README.md`, `docs/**`, `AGENTS.md`, `RELEASING.md`, `CHANGELOG.md`, `daemons/**/*.md`, and `.agents/daemons/**/*.md`
- Generated documentation policy: `examples.json` is a generated public catalog from `daemons/**`; do not hand-edit it. If example package metadata or daemon example content changes, run `bun run generate:examples` and commit the generated catalog output.
- Documentation verification: run `git diff --check`; when changes touch example packages, catalog docs, or generated catalog behavior, also run `bun run generate:examples` and `bun run validate:examples`.

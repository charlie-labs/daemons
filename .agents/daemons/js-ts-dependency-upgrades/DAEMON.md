...
- Runtime dependency update: `bun update yaml` for the current runtime dependency listed under `dependencies` in `package.json`
- Development dependency update: `bun update @types/bun typescript vitest` for the current development dependencies listed under `devDependencies` in `package.json`

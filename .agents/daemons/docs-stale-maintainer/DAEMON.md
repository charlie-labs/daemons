...
- Source evidence locations: `src/**`, `scripts/**`, `daemons/**`, `skills/**`, `.github/**`, `package.json`, `bun.lock`, `tsconfig.json`, `examples.json`, recent Git history, and closed pull requests

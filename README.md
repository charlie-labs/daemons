...
| PR test-gap review | `pr-test-gap-review` | [daemons/pr-test-gap-review/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/pr-test-gap-review/DAEMON.md) | Finds only concrete, diff-scoped gaps in pull request test evidence and suggests the narrowest useful verification. |

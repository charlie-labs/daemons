...
| Issue hygiene | `bug-context-researcher` | [daemons/bug-context-researcher/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/bug-context-researcher/DAEMON.md) | Adds concise repo-aware triage context to newly created bugs and regressions on the selected issue platform. |
| Issue hygiene | `issue-duplicate-finder` | [daemons/issue-duplicate-finder/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/issue-duplicate-finder/DAEMON.md) | Suggests likely duplicate or related issues when new issues are created on the selected issue platform. |
| Issue hygiene | `issue-labeler` | [daemons/issue-labeler/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/issue-labeler/DAEMON.md) | Keeps recently changed issues aligned with the current label set on the selected issue platform. |

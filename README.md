...
| GitHub issue hygiene | `github-bug-context-researcher` | [daemons/github-bug-context-researcher/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/github-bug-context-researcher/DAEMON.md) | Adds concise repository-aware triage context to newly opened GitHub bugs and regressions. |
| GitHub issue hygiene | `github-issue-duplicate-finder` | [daemons/github-issue-duplicate-finder/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/github-issue-duplicate-finder/DAEMON.md) | Suggests likely duplicate or related GitHub issues when new issues are opened. |
| GitHub issue hygiene | `github-issue-labeler` | [daemons/github-issue-labeler/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/github-issue-labeler/DAEMON.md) | Keeps recently changed GitHub issues aligned with the installed repository's current label set. |
...
| PR review | `pr-review` | [daemons/pr-review/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/pr-review/DAEMON.md) | Reviews pull requests for concise, evidence-backed risks and makes bounded weekly proposals to improve its review policy. |

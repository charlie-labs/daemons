...
| PR review | `pr-review` | [daemons/pr-review/DAEMON.md](https://github.com/charlie-labs/daemons/blob/master/daemons/pr-review/DAEMON.md) | Reviews pull requests for concise, evidence-backed correctness and repository-policy risks before merge. |
